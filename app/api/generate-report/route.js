...
export async function POST(req) {
  try {
    const { profile, workouts } = await req.json();
...
Età: ${profile.age}, Peso: ${profile.weight}kg, Altezza: ${profile.height}cm, Massa Grassa: ${profile.body_fat}%, Livello: ${profile.activity_level}.
